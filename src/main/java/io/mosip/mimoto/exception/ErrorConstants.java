...
public enum ErrorConstants {
    ...
    ONE_ATTEMPT_LEFT_BEFORE_PERMANENT_LOCK("one_attempt_left_before_permanent_lock", "Incorrect passcode. Last attempt remaining before your Wallet is permanently locked"),
