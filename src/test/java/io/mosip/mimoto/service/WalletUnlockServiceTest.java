...
//        doNothing().when(walletStatusService).getErrorBasedOnWalletLockStatus(wallet);
...
//        verify(walletStatusService, times(1)).getErrorBasedOnWalletLockStatus(wallet);
...
//        verify(walletStatusService, times(2)).getErrorBasedOnWalletLockStatus(wallet);
...
//        when(walletLockManager.enforceLockCyclePolicy(wallet)).thenReturn(wallet);
//        doNothing().when(walletStatusService).validateLastAttemptBeforeLockout(wallet);
//        doNothing().doThrow(new WalletLockedException(ErrorConstants.WALLET_PERMANENTLY_LOCKED.getErrorCode(), ErrorConstants.WALLET_PERMANENTLY_LOCKED.getErrorMessage())).when(walletStatusService).getErrorBasedOnWalletLockStatus(wallet);
...
//        doThrow(walletLockedException).when(walletStatusService).getErrorBasedOnWalletLockStatus(wallet);
//
//        String expectedErrorMessage = ErrorConstants.WALLET_PERMANENTLY_LOCKED.getErrorCode() + " --> " + ErrorConstants.WALLET_PERMANENTLY_LOCKED.getErrorMessage();
//
//        WalletLockedException exception = assertThrows(WalletLockedException.class, () ->
