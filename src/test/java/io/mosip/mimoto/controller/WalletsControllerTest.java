...
public class WalletsControllerTest {
    ...
    public void shouldThrowExceptionIfReceivedPINAndConfirmPINDoNotMatch() throws Exception {
        ...
        when(walletService.createWallet(userId, walletName, walletPin, "2345"))
                .thenThrow(new InvalidRequestException(ErrorConstants.INVALID_REQUEST.getErrorCode(), "Entered PIN and confirmation PIN do not match"));
        ...
        mockMvc.perform(post("/wallets")
                ...
                .andExpect(jsonPath("$.errorMessage").value("invalid_request --> Entered PIN and confirmation PIN do not match"));
    }
