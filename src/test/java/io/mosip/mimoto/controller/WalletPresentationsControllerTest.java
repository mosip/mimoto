...
public class WalletPresentationsControllerTest {
    ...
    public void setup() {
        ...
        presentationResponseDTO = new VPResponseDTO("presentationId-123", presentationVerifierDTO, false);
    ...
    public void testCreatePresentationSuccess() throws Exception {
        ...
        when(walletPresentationService.handleVPAuthorizationRequest(authorizationRequest.getAuthorizationRequestUrl(), walletId)).thenReturn(new VPAuthorizationResult(presentationResponseDTO, null));
    ...
    public void shouldThrowBadRequestWhenApiNotAccessibleExceptionIsThrown() throws Exception {
        ...
        VerifiablePresentationSessionData sessionData = new VerifiablePresentationSessionData(
                presentationId, "authorizationRequestUrl", java.time.Instant.now(), true, null, false, null);
